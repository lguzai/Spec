filename <- ".//benchmark_results//OliveOil.xlsx"
wb <- createWorkbook(type="xlsx")


Ncol <- vapply(OliveOil.Results$AMOC_10, length, 1L)
AMOC <- matrix(0, nrow = length(OliveOil.Results$AMOC_10), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
AMOC[IJ] <- unlist(OliveOil.Results$AMOC_10, use.names = FALSE)
...
Ncol <- vapply(OliveOil.Results$BinSeg_10, length, 1L)
BinSeg <- matrix(0, nrow = length(OliveOil.Results$BinSeg_10), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
BinSeg[IJ] <- unlist(OliveOil.Results$BinSeg_10, use.names = FALSE)
...
Ncol <- vapply(OliveOil.Results$SegNeigh_10, length, 1L)
SegNeigh <- matrix(0, nrow = length(OliveOil.Results$SegNeigh_10), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
SegNeigh[IJ] <- unlist(OliveOil.Results$SegNeigh_10, use.names = FALSE)
...
Ncol <- vapply(OliveOil.Results$PELT_10, length, 1L)
PELT <- matrix(0, nrow = length(OliveOil.Results$PELT_10), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
PELT[IJ] <- unlist(OliveOil.Results$PELT_10, use.names = FALSE)
...
Ncol <- vapply(OliveOil.Results$EDivisive_10, length, 1L)
EDivisive <- matrix(0, nrow = length(OliveOil.Results$EDivisive_10), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
EDivisive[IJ] <- unlist(OliveOil.Results$EDivisive_10, use.names = FALSE)
...
Ncol <- vapply(OliveOil.Results$EDM_10, length, 1L)
EDM <- matrix(0, nrow = length(OliveOil.Results$EDM_10), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
EDM[IJ] <- unlist(OliveOil.Results$EDM_10, use.names = FALSE)
...
Ncol <- vapply(OliveOil.Results$MFT_10, length, 1L)
MFT <- matrix(0, nrow = length(OliveOil.Results$MFT_10), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
MFT[IJ] <- unlist(OliveOil.Results$MFT_10, use.names = FALSE)
...
Ncol <- vapply(OliveOil.Results$Breakfast_10, length, 1L)
Breakfast <- matrix(0, nrow = length(OliveOil.Results$Breakfast_10), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
Breakfast[IJ] <- unlist(OliveOil.Results$Breakfast_10, use.names = FALSE)
...
Ncol <- vapply(OliveOil.Results$gSeg_10, length, 1L)
gSeg <- matrix(0, nrow = length(OliveOil.Results$gSeg_10), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
gSeg[IJ] <- unlist(OliveOil.Results$gSeg_10, use.names = FALSE)
...
Ncol <- vapply(OliveOil.Results$SpecDetec_10, length, 1L)
Spec <- matrix(0, nrow = length(OliveOil.Results$SpecDetec_10), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
Spec[IJ] <- unlist(OliveOil.Results$SpecDetec_10, use.names = FALSE)
