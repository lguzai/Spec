filename <- "./BirdChicken.xlsx"
wb <- createWorkbook(type="xlsx")


Ncol <- vapply(BirdChicken.Results$AMOC, length, 1L)
AMOC <- matrix(0, nrow = length(BirdChicken.Results$AMOC), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
AMOC[IJ] <- unlist(BirdChicken.Results$AMOC, use.names = FALSE)
...
Ncol <- vapply(BirdChicken.Results$BinSeg, length, 1L)
BinSeg <- matrix(0, nrow = length(BirdChicken.Results$BinSeg), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
BinSeg[IJ] <- unlist(BirdChicken.Results$BinSeg, use.names = FALSE)
...
Ncol <- vapply(BirdChicken.Results$SegNeigh, length, 1L)
SegNeigh <- matrix(0, nrow = length(BirdChicken.Results$SegNeigh), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
SegNeigh[IJ] <- unlist(BirdChicken.Results$SegNeigh, use.names = FALSE)
...
Ncol <- vapply(BirdChicken.Results$PELT, length, 1L)
PELT <- matrix(0, nrow = length(BirdChicken.Results$PELT), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
PELT[IJ] <- unlist(BirdChicken.Results$PELT, use.names = FALSE)
...
Ncol <- vapply(BirdChicken.Results$EDivisive, length, 1L)
EDivisive <- matrix(0, nrow = length(BirdChicken.Results$EDivisive), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
EDivisive[IJ] <- unlist(BirdChicken.Results$EDivisive, use.names = FALSE)
...
Ncol <- vapply(BirdChicken.Results$EDM, length, 1L)
EDM <- matrix(0, nrow = length(BirdChicken.Results$EDM), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
EDM[IJ] <- unlist(BirdChicken.Results$EDM, use.names = FALSE)
...
Ncol <- vapply(BirdChicken.Results$MFT, length, 1L)
MFT <- matrix(0, nrow = length(BirdChicken.Results$MFT), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
MFT[IJ] <- unlist(BirdChicken.Results$MFT, use.names = FALSE)
...
Ncol <- vapply(BirdChicken.Results$Breakfast, length, 1L)
Breakfast <- matrix(0, nrow = length(BirdChicken.Results$Breakfast), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
Breakfast[IJ] <- unlist(BirdChicken.Results$Breakfast, use.names = FALSE)
...
Ncol <- vapply(BirdChicken.Results$gSeg, length, 1L)
gSeg <- matrix(0, nrow = length(BirdChicken.Results$gSeg), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
gSeg[IJ] <- unlist(BirdChicken.Results$gSeg, use.names = FALSE)
...
Ncol <- vapply(BirdChicken.Results$SpecDetec, length, 1L)
Spec <- matrix(0, nrow = length(BirdChicken.Results$SpecDetec), ncol = max(Ncol))
IJ <- cbind(rep(seq_along(Ncol), times = Ncol), sequence(Ncol)) 
Spec[IJ] <- unlist(BirdChicken.Results$SpecDetec, use.names = FALSE)
